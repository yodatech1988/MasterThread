# Patreon Orchestrator Agent Responsibilities

The **Patreon Orchestrator Agent** is responsible for the following:

- Interpret inputs and events relevant to the **Patreon Orchestrator** function.
