...
| [site-badlands](https://github.com/yodatech1988/site-badlands) | Future AEGIS site on Nasdara Province (DayZ Badlands DLC, ships **Oct 15 2026**). Created 2026-09-14 to prep as close to release-day playable as possible | `docs/PLAN.md` ([#1](https://github.com/yodatech1988/site-badlands/pull/1), 3 sessions; Session 0 research + plan merged) | Session 1: register the 1.29 "Road to Badlands" preview items (SCR-17, Holo Sight, desert gear, tanker helmet, military cap, brass knuckles) into the live economy — a **site-chernarus** PR, tracked from here. Session 2: mod-ecosystem (DayZ-Expansion et al.) Nasdara-readiness tracker | Second-server hosting decision needed before Session 3 finishes (current VYKIX plan covers one Chernarus instance only) |
