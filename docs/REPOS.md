...
| [aegis-mods](https://github.com/yodatech1988/aegis-mods) | Every AEGIS Workshop module: Metrics, TeddyBear, Economy, Skins merged. Next: clean-room replacement of the removed Terje mods | `docs/PLAN.md` ([#15](https://github.com/yodatech1988/aegis-mods/pull/15): Sessions 1–11 `AEGIS_Core`, `AEGIS_Skills`, `AEGIS_Medicine`, `AEGIS_StartScreen`; 12–15 move PvPGuard, Vehicles, Aircraft, Quest 1033) | Merge #15. Round A in parallel: research lanes #9–#14 (issues, no PRs). Then Session 1: build `AEGIS_Core` | Faction-name mapping sign-off (site-chernarus `nasdara-factions-and-quests.md`); confirm Terje Workshop items unsubscribed on Steam; Workshop publisher account when a module is ready |
