...
| `click-file-builder` | sonnet | **D** | yes | Drafts an owner-run click-file pair (typed-YES gate, -WhatIf, retired guard, separate undo file); exercises only -WhatIf in scratch; never applies | `skills/owner-click/SKILL.md` |
