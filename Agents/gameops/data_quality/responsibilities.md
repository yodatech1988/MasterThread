    # Data Quality Agent Responsibilities

    The **Data Quality Agent** is responsible for the following:

    - Interpret inputs and events relevant to the **Data Quality** function.
