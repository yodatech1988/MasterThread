    # Dayz Operations Agent Responsibilities

    The **Dayz Operations Agent** is responsible for the following:

    - Interpret inputs and events relevant to the **Dayz Operations** function.
