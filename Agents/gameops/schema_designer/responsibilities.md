    # Schema Designer Agent Responsibilities

    The **Schema Designer Agent** is responsible for the following:

    - Interpret inputs and events relevant to the **Schema Designer** function.
