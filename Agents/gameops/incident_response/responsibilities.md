    # Incident Response Agent Responsibilities

    The **Incident Response Agent** is responsible for the following:

    - Interpret inputs and events relevant to the **Incident Response** function.
