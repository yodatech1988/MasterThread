# Patreon Perks Agent Responsibilities

The **Patreon Perks Agent** is responsible for the following:

- Interpret inputs and events relevant to the **Patreon Perks** function.
