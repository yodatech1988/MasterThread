# Cohort Analytics Agent Responsibilities

The **Cohort Analytics Agent** is responsible for the following:

- Interpret inputs and events relevant to the **Cohort Analytics** function.
