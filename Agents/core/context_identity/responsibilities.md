    # Context Identity Agent Responsibilities

    The **Context Identity Agent** is responsible for the following:

    - Interpret inputs and events relevant to the **Context Identity** function.
