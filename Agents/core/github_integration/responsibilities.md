    # Github Integration Agent Responsibilities

    The **Github Integration Agent** is responsible for the following:

    - Interpret inputs and events relevant to the **Github Integration** function.
