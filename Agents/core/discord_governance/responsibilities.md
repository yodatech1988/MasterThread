# Discord Governance Agent Responsibilities

The **Discord Governance Agent** is responsible for the following:

- Interpret inputs and events relevant to the **Discord Governance** function.
