# Rom Estimator Agent Responsibilities

The **Rom Estimator Agent** is responsible for the following:

- Interpret inputs and events relevant to the **Rom Estimator** function.
