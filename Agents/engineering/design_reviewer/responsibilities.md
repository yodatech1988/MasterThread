# Design Reviewer Agent Responsibilities

The **Design Reviewer Agent** is responsible for the following:

- Interpret inputs and events relevant to the **Design Reviewer** function.
