# Training Tutorial Agent Responsibilities

The **Training Tutorial Agent** is responsible for the following:

- Interpret inputs and events relevant to the **Training Tutorial** function.
