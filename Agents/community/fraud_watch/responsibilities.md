# Fraud Watch Agent Responsibilities

The **Fraud Watch Agent** is responsible for the following:

- Interpret inputs and events relevant to the **Fraud Watch** function.
