# Community Analytics Sentiment Agent Responsibilities

The **Community Analytics Sentiment Agent** is responsible for the following:

- Interpret inputs and events relevant to the **Community Analytics Sentiment** function.
