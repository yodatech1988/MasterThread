# Faq Knowledge Agent Responsibilities

The **Faq Knowledge Agent** is responsible for the following:

- Interpret inputs and events relevant to the **Faq Knowledge** function.
